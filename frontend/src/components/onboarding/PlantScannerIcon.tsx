...
export default function PlantScannerIcon() {
    const cornerStyle = "absolute border-ink-inverse/45 size-6"

    return (
        <div className="relative inline-flex items-center justify-center p-12">
            <div className="absolute top-[25%] bottom-[25%] left-[30%] right-[20%] bg-ink-inverse/10 rounded-xl" />
            ...
            <PiPlantLight size={180} className="text-primary-light" />
        </div>
    )
}